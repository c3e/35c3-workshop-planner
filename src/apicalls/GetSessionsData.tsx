...
export default class GetSessionsData {
  ...
  private static API_URL = 'https://events.ccc.de/congress/2017/wiki/api.php?action=query&prop=revisions&rvprop=ids|timestamp|user|userid|size|tags|parsetree&format=json&pageids=';
